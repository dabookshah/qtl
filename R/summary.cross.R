    ...
    function(object,...)
{
    ...
    if(!(type %in% c("f2", "bc", "4way", "riself", "risib", "dh", "haploid",
                     "ri4self", "ri4sib", "ri8self", "ri8selfIRIP1", "ri8selfIRIP2", "ri8selfIRIP3", "ri8sib", "bcsft", "bgmagic16")))
    ...
    else if(type %in% c("ri4sib", "ri4self", "ri8sib", "ri8self", "ri8selfIRIP1", "ri8selfIRIP2", "ri8selfIRIP3", "bgmagic16")) {
    ...
    function(x,...)
{
    ...
    else if(x$type %in% c("ri4self", "ri4sib", "ri8self", "ri8selfIRIP1", "ri8selfIRIP2", "ri8selfIRIP3", "ri8sib")) {

    ...
    function(object,...)
{
  ...
  if(!(type %in% c(IRIPCrosses, "f2", "bc", "4way", "riself", "risib", "dh", "haploid",
  ...
  else if(type %in% c(IRIPCrosses, "ri4sib", "ri4self", "ri8sib", "ri8self", "bgmagic16")) {
    ...
    function(x,...)
{
  ...
  else if(x$type %in% c(IRIPCrosses, "ri4self", "ri4sib", "ri8self", "ri8sib")) {
